"""
Xiangqi Level 2 Generator: Complex Movement Rules
...
class Level2Generator:
    """Generate Level 2 test cases - complex movement rules"""
    ...
    def __init__(self, seed: int = 42):
        ...
        # Piece types to test
        self.piece_types = ['knight', 'bishop', 'king', 'advisor']
    ...
    def _generate_knight_valid(self, case_num: int) -> Optional[Dict]:
        ...
        for _ in range(50):
            ...
            pieces = {start: self._piece_symbol('knight', color)}
            return {
                ...
                "question": f"Can the Knight move from {start} to {target}?",
                "expected": "yes",
