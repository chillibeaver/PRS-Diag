...
class ChessVerificationGenerator:
    ...
    def generate_verification(case: Dict) -> Dict:
        ...
        for i, state in enumerate(states):
            ...
            for sq, piece in pieces.items():
                ...
                piece_type = ChessVerificationGenerator._get_piece_type(piece)
    ...
    def check_verification_answer(response: str, case: Dict) -> bool:
        ...
        for piece_info in verification_pieces:
            ...
            if not ChessVerificationGenerator._check_color_piece_association(
    ...
    def _check_color_piece_association(response: str, color: str, piece_type: str, position: str) -> bool:
        ...
        # piece entries (e.g., "Black Pawn at c7, White Pawn at d5" should
        # NOT let wrong_pattern "black\s+pawn.*?d5" span across entries)
