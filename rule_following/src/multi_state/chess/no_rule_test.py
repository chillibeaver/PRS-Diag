"""
Chess No Rule Multi-State Test
Tests basic temporal/multi-state understanding without chess rules
"""
...
class ChessNoRuleTest(MultiStateTestBase):
    """Test 0: Pure temporal understanding (no chess rules)"""

    def __init__(self,
                 base_output_dir: str = "./output/multi_state/chess_no_rule",
                 n_cases: int = 100,  # Updated to use n_cases
        ...
        super().__init__(
            test_name="Chess No Rule (Temporal)",
            test_layer=0,
        ...
        self.verification_gen = ChessMultiStateVerificationGenerator()
