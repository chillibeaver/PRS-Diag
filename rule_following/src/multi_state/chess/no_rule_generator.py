"""
Automated test case generator for Chess No-Rule Multi-State Test
(Formerly Temporal Test 0)
...
class ChessNoRuleGenerator:
    """Automatically generate chess multi-state reasoning test cases (No Rules)"""
...
- Answer 'unknown' if you cannot determine"""
    ...
    def generate_all(self, n_cases: int = 100) -> List[Dict]:
        ...
        # Distribute n_cases among the 4 main types
